...
type PlaceWithAddressComponents = {
  address_components: LocationAddressComponent[];
};
...
export const getLocationDataFromExif = (exif: ExifLocation) => {
  let {
...
export const checkAddressNotBelongsToNY = (place: PlaceWithAddressComponents) => {
...
export const findInLocation = (address: LocationAddressComponent[], key: string) => {
  const res = address
