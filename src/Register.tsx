...
import { Badge, CheckBox, Input, Icon } from "react-native-elements";
...
export default function Register() {
  ...
  const [stateError, setError] = React.useState<string | null>(null);
  ...
  const onEmailBlur = (onlySuccess: boolean) => {
    let emailError = null;
